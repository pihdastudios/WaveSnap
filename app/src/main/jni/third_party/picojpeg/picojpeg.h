...
// WaveSnap extension: If reduce is 2, only the JPEG luminance DC value is written to m_pMCUBufR. Chroma entropy is still consumed, but RGB conversion is skipped.
// Not thread safe.
